...
### vnc under ssh tunnel
- server side: `vncserver :66 -geometry 1920x1080`
- client side: using SSH for secure reason.
    - `-L 7777:localhost:5966`: forward localhost 7777 to remote 5966
    ```
    # step 1
    ssh -p 22 -v -C -L 7777:localhost:5966 xxxUser@xxx_server.com
    # step 2
    use vnc-client connecting to localhost:7777
    ```

## QEMU standalone running
from: http://lastweek.io/misc/cheatsheet/
```
